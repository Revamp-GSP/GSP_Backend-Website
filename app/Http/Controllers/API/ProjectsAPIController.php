...
class ProjectsAPIController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'dirut' => 'required|string',
            'dirop' => 'required|string',
            'dirke' => 'required|string',
            'kskmr' => 'required|string',
            'ksham' => 'required|string',
            'msdmu' => 'required|string',
            'mkakt' => 'required|string',
            'mbilp' => 'required|string',
            'mppti' => 'required|string',
            'mopti' => 'required|string',
            'mbsar' => 'required|string',
            'msadb' => 'required|string',
        ]);
